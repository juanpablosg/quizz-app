...
struct QuizBrain {
    ...
    var currentQuestion: Question { quiz[questionNumber] }
    var progress: Float { Float(questionNumber) / Float(quiz.count - 1) }
...
//    mutating func getScore(_ userResult: Bool) -> Int {
//
//        if questionNumber == 0 {
//            score = 0
//        } else {
